...
router.get('/', (req, res) => {
    ...
    try{
        ...
        console.log('error al intentar obtener listado ::', error)
    }
})
...
router.get('/:id', (req, res) => {
    ...
    try{
        ...
        console.log('error desde el metodo get por un id, ', error)
    }
})
...
router.put('/:id', (req,res) => {
    ...
    try{
        ...
        console.log('ha ocurrido un error con el metodo put')
    }
})
